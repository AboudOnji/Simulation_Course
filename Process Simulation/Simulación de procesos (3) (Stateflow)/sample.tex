...
% -------
\section{Ejemplo carga de batería}
\begin{frame}{Sistema de Carga de Batería}
    \begin{block}{Descripción}
       El sistema de baterías tiene estos requisitos:
       \begin{itemize}
           \item La batería se carga cuando se conecta a una fuente de potencia externa. De lo contrario, se descarga.
           \item La capacidad de la batería se carga a una velocidad del 4\% de la carga total y se descarga a una velocidad del 3\%.
           \item Cuando se está cargando, la batería no genera potencia. Cuando se está descargando, la batería genera 3,5 vatios de potencia. 
       \end{itemize}
    \end{block}
    \begin{exampleblock}{Solución}
        \url{https://la.mathworks.com/help/stateflow/gs/get-started-create-chart.html}
    \end{exampleblock}
    \end{frame}
