...
\begin{frame}{Ambigüedad en la Representación}
...
\begin{frame}{Componentes del Motor de Simulación DES}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.20\textwidth]{Figuras/Cap8/fig18.2.png}
...
\begin{frame}{Distribución Uniforme y el Método Congruencial Lineal}
    \begin{columns}[c]
        \column{0.45\textwidth}
            ...
            \begin{figure}
                \includegraphics[width=0.9\linewidth]{Figuras/Cap8/fig8.4.png}
...
\begin{frame}{Generación de Números con Distribución Gaussiana}
    \begin{columns}[c]
        \column{0.45\textwidth}
            ...
            \begin{figure}
                \includegraphics[width=0.9\linewidth]{Figuras/Cap8/fig8.5.png}
...
rng(0);
secuencia2 = rand(1, 3)
% secuencia2 sera identica a secuencia1
\end{lstlisting}
\end{frame}
...
\begin{frame}{Patrones de Diseño en SimEvents}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{Figuras/Cap8/fig8.6.png}
...
\begin{frame}[fragile]{Ejemplo: Timestamping}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{Figuras/Cap8/fig8.20.png}
...
\begin{frame}[fragile]{Ejemplo: Timestamping}
    ...
    \begin{itemize}
        \item Acción 'Generate' del Generador: Llama a la función para registrar el \texttt{TimeStampGeneration}.
        \item Acción 'Service complete' del Servidor: Llama a la función para registrar el \texttt{TimeStampServiceComplete} y calcula el \texttt{TotalTime}.
    \end{itemize}
\end{frame}
...
\column{0.5\textwidth}
    ...
    Se puede pasar el valor de un atributo a un componente de Simulink (como un bloque Gain) para realizar cálculos.
        \begin{figure}
        \includegraphics[width=0.8\linewidth]{Figuras/Cap8/fig8.21.png}
...
\column{0.5\textwidth}
    ...
    Se pueden usar datos de una hoja de cálculo para definir parámetros, como los tiempos entre llegadas de entidades.
        \begin{figure}
        \includegraphics[width=0.8\linewidth]{Figuras/Cap8/fig8.22.png}
